...
<section>
    <div class="container">
        <div class="game"> <iframe src="https://html5.gamedistribution.com/9abe6af0fbb440b98a3e24bf7fb0636a/" width="800" height="400" scrolling="none" frameborder="0"></iframe>
        </div>
        <div class="suggest">
            <h1>Suggestions</h1>
        ...
        <div class="title">
            <h1 style="color:var(--color-primary);">Impostor</h1>
        </div>
        <div class="description">
            <p> Welcome to impostor!<br><br>Impostor is a great Among us spin-off, where you are always the imposter. Good luck and do not be sussy! </p>
        </div>
