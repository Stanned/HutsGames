...
<section>
    <div class="container">
        <div class="game"> <iframe src="https://html5.gamedistribution.com/31aa63d5b8e74fc8af0562fa909ae9df/" width="800" height="400" scrolling="none" frameborder="0"></iframe>
        </div>
        <div class="suggest">
            <h1>Suggestions</h1>
        ...
        <div class="title">
            <h1 style="color:var(--color-primary);">Pixel Warrior</h1>
        </div>
        <div class="description">
            <p> Welcome to Pixel Warrior!<br><br> Pixel Warrior is survival shooter game. 
                Protect and defend the army camp against zombies. 
                Huge military arsenal such as AK minigun sniper guns pistols. 
                Have a fun time!</p>
        </div>
