...
<section>
    <div class="container">
        <div class="game"> <iframe src="https://html5.gamedistribution.com/8b07c146af9d412cb5419b7ec48d5d0e/" width="800" height="400" scrolling="none" frameborder="0"></iframe>
        </div>
        <div class="suggest">
            <h1>Suggestions</h1>
        ...
        <div class="title">
            <h1 style="color:var(--color-primary);">Backflip Adventure</h1>
        </div>
        <div class="description">
            <p> Welcome to Backflip Adventure!<br><br> Beat creative and fun levels! Unlock new parkour spots to do somersaults Land on specific targets, 
                jump from an amazing variety of locations, 
                from an ordinary city to a haunted house or an amazing island, 
                perform awesome back and forth flips to score more points, 
                there are many levels to explore!</p>
        </div>
