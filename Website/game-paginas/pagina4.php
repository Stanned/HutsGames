...
<section>
    <div class="container">
        <div class="game"> <iframe src="https://html5.gamedistribution.com/5903aae9aa6549cdb51b42355b9bbffb/" width="800" height="400" scrolling="none" frameborder="0"></iframe>
        </div>
        <div class="suggest">
            <h1>Suggestions</h1>
        ...
        <div class="title">
            <h1 style="color:var(--color-primary);">Stupid Chicken</h1>
        </div>
        <div class="description">
            <p> Welcome to Stupid Chicken!<br><br> At this game you need to feed the chicken to get an egg. 
                 Click on the screen for chicken to peck at the food given by the child farmer. 
                 You can also eat insects that are near you. After the chicken eats, she can lay an egg. 
                 Try to lay more eggs for given time. When the game is over you can change the eggs for more time to play. 
                 At that way you can increase your playing time and progress in the game </p>
        </div>
