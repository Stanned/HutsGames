...
<header>
    <div id="headerContainer">
        <div class="headerItem"><a href="../index.html"><img width="250" src="../images/logo-big.png"
                                                             alt="HutsGames Logo"></a></div>
...
<div id="registerBoxContainer">
    <form action="index.php" name="registerForm" method="post" id="form"
          onsubmit="return validateName() && validateEmail() && validatePassword() && validatePasswordSame()">
        <input class="registerforminput arrow-togglable" autocomplete="off" type="text" placeholder="Username"
               name="username" id="userInput" onkeyup="checkName()" required><br>
        <input class="registerforminput arrow-togglable emailBox" type="email" placeholder="Email address" name="email"
               id="emailInput" onkeyup="checkEmail();" required><br>
        <input class="registerforminput arrow-togglable passwordBox" autocomplete="off" type="password"
               placeholder="Password" name="password" id="passwordInput" onkeyup="checkPassword();" required></br>
        <input class="registerforminput arrow-togglable" autocomplete="off" type="password"
               placeholder="Confirm password" name="passwordConfirm" id="passwordConfirmInput"
               onkeyup="checkPasswordsSame()" required></br>
        <span id="message"></span><br>
        <p id="TermsAcceptLine"> By signing up you agree to the <a href="../terms-of-service.html" target="blank_">Terms
                of Service</a></p>
